...
function msg_valid(msg)
  -- Don't process outgoing messages
    if msg.out then
    print('\27[36mNot valid: msg from us just we seted stat\27[39m')
    return false
  end
...
function save_chats( )
  serialize_to_file(_chats, './data/chatsid.lua')
  print ('saved gban into ./data/chatsid.lua')
end
...
function load_chats( )
  local f = io.open('./data/chatsid.lua', "r")
  -- If chatsid.lua doesn't exist
  if not f then
    print ("Created new chats file: data/chatsid.lua")
    create_chats()
  else
    f:close()
  end
  local chats = loadfile ("./data/chatsid.lua")()
  return chats
end
...
function create_chats( )
  ...
  serialize_to_file(chats, './data/chatsid.lua')
  print ('saved chats into ./data/chatsid.lua')
end
